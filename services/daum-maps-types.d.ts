...
export interface Tileset {
    constructor(width: number, height: number, urlFunc: number, copyright: number, dark: number, minZoom: number, maxZoom: number): void;
...
export declare enum ProjectionId {
    /**
...
export declare enum CopyrightPosition {
    BOTTOMLEFT = 0,
    BOTTOMRIGHT = 1,
}
